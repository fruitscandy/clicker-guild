...
const PRESET_AMOUNTS: Record<DeveloperResourcePreset, { gold: number; material: number }> = {
  empty: { gold: 0, material: 0 },
  ready: { gold: 100_000, material: 99 },
  abundant: { gold: 99_999_999, material: 999 },
};
