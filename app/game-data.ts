...
import { stageBaseHpFor } from "./game-balance.ts";
...
export const MEMBER_COMBAT_TRAITS: Record<string, MemberCombatTrait> = {
  roan: { style: "vanguard", title: "선봉 검진", description: "1.5초마다 칼날을 자동 발동하고 강타로 적 무리를 압박합니다." },
  mia: { style: "marksman", title: "추적 화살", description: "빠른 화살을 자동 발사하고 연속 사격을 주기적으로 쏟아냅니다." },
  finn: { style: "assassin", title: "급소 추격", description: "짧은 주기로 단검을 던지고 급소 찌르기를 자동 발동합니다." },
  lulu: { style: "arcane", title: "마력 대폭발", description: "마력탄과 광역 마법을 자신의 주기에 맞춰 자동 발동합니다." },
  ellie: { style: "support", title: "빛의 격려", description: "빛의 공격을 자동 발동하며 다른 길드원의 공격 주기를 단축합니다." },
  garon: { style: "vanguard", title: "철벽 돌진", description: "방패 강타를 자동 발동하며 길드원 패시브 공격의 위력을 보강합니다." },
  reina: { style: "marksman", title: "정조준 연사", description: "정확한 원거리 사격과 정조준 스킬을 자동으로 반복합니다." },
  bruno: { style: "breaker", title: "난전 본능", description: "빠른 주먹 연타와 삼연격을 자동으로 이어갑니다." },
  sera: { style: "arcane", title: "화염 폭발", description: "화염탄을 자동 발사하고 주기적으로 광역 폭발을 일으킵니다." },
  popo: { style: "breaker", title: "부식 물약", description: "부식 물약을 자동 투척해 적 무리를 지속적으로 타격합니다." },
  kyle: { style: "vanguard", title: "관통 전열", description: "창격과 관통 돌진을 주기적으로 자동 발동합니다." },
  nera: { style: "assassin", title: "그림자 처형", description: "빠른 그림자 칼날과 강력한 암살 스킬을 자동 발동합니다." },
  iris: { style: "arcane", title: "빙결 파동", description: "빙결 파편과 광역 얼음 마법을 주기적으로 자동 발동합니다." },
  rio: { style: "support", title: "전투의 노래", description: "음파 공격을 자동 발동하고 길드원 전체의 공격 리듬을 높입니다." },
  jade: { style: "marksman", title: "도탄 속사", description: "짧은 간격의 총격과 속사를 자동으로 반복합니다." },
  ur: { style: "breaker", title: "분노의 도끼", description: "묵직한 도끼 공격과 분노의 일격을 자동 발동합니다." },
  adel: { style: "support", title: "성전의 맹세", description: "신성 공격을 자동 발동하고 길드원 패시브 화력을 보강합니다." },
  theo: { style: "arcane", title: "연쇄 번개", description: "번개탄과 연쇄 번개를 주기적으로 자동 발동합니다." },
  nabi: { style: "support", title: "바람 정령", description: "정령 공격을 자동 발동하고 길드원 전체의 공격 속도를 높입니다." },
  ren: { style: "assassin", title: "발도 처형", description: "날카로운 검격과 발도술을 자신의 주기에 맞춰 자동 발동합니다." },
  gray: { style: "marksman", title: "마력 포격", description: "포탄과 광역 마력 포격을 느리지만 강력하게 자동 발동합니다." },
  mor: { style: "support", title: "망자의 군세", description: "망자의 손을 자동 소환하고 길드원 패시브 공격을 보조합니다." },
  aila: { style: "arcane", title: "마력 참격", description: "마검의 참격과 광역 마법을 주기적으로 자동 발동합니다." },
  drake: { style: "vanguard", title: "용의 돌진", description: "용창 공격과 강력한 돌진을 자동으로 반복합니다." },
  zello: { style: "breaker", title: "왕가의 분열", description: "분열 공격과 왕가의 폭발을 빠르게 자동 발동합니다." },
};
