...
export const SPECIAL_ATTACKS: Record<SpecialAttackKind, SpecialAttackDefinition> = {
  lightning: {
    ...
    title: "번개",
    subtitle: "천뢰의 인장",
    description: "5.2초마다 밀집한 적에게 연쇄 번개가 떨어져 최대 7체를 감전시킵니다.",
    glyph: "⚡",
  ...
  tornado: {
    ...
    title: "토네이도",
    subtitle: "폭풍의 감옥",
    description: "8.4초마다 회오리가 적을 끌어당기며 세 차례 광역 피해를 줍니다.",
    glyph: "◉",
  ...
  meteor: {
    ...
    title: "메테오",
    subtitle: "운석 충돌",
    description: "11.8초마다 메테오가 낙하해 대폭발 피해를 주고 적을 전장 안쪽으로 날려 보냅니다.",
    glyph: "☄",
