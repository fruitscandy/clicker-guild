...
- handoff: 핵심 강화 8종(각 5단계)과 특수 공격 3종으로 개편 완료. 삭제 연구는 구매 골드를 환급하고 기존 장비 수치는 길드원 경험치로 전환한다. 최대 자동 공격은 2.6초 주기로 제한했으며 핵심 무기·본관·연구 비용 합계 280,570 G가 30웨이브 1회 수입 292,660 G 안에 들도록 검증했다. ESLint, 82개 테스트, 프로덕션 빌드와 데스크톱·모바일 브라우저 점검 통과.
